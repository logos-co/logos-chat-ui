// Select the most-recent conversation in an already-running logos-chat-ui
...
main().then(() => process.exit(0)).catch((e) => { console.error("select-latest FAILED:", e.message); process.exit(1); });
