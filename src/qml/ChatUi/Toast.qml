...
// Transient error notification shown in the window overlay, above modal dialogs.
// Call show(message); it auto-dismisses after a few seconds, a tap dismisses it
// sooner. A new show() replaces the current message.
...
Popup {
    ...
    y: parent ? parent.height - height - Theme.spacing.xxlarge : 0
